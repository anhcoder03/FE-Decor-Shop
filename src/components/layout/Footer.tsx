const Footer = () => {
  return (
    <div>
      <footer className="text-center bg-[#111111] text-neutral-600 dark:text-neutral-200 lg:text-left">
        <div className="flex items-center justify-center p-6 border-b-2 border-neutral-200 bg-neutral-600 dark:border-neutral-500 lg:justify-between">
        ...
        <div className="p-2 text-center bg-neutral-600">
